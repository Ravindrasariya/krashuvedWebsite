...
const products = [
  ...
  },
  {
    ...
    nameHi: "\u0915\u093F\u0938\u093E\u0928 \u0910\u092A",
    descEn:
      "Check crop trends, book seed and soil tests, manage farming activities, track crop timelines, and handle rental machinery dues \u2014 all from phone. Empowering farmers with technology.",
    descHi:
